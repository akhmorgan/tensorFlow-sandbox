# BASED ON: https://www.kaggle.com/mrcrbraun/classify-zoo-animals-artificial-neural-network
import numpy as np # linear algebra
import pandas as pd # data processing, CSV file I/O (e.g. pd.read_csv)
from tensorflow import keras
from sklearn.preprocessing import OneHotEncoder

dataset = pd.read_csv("./zoo-animal-classification/zoo.csv")
dataset.head()
...
classifier.add(keras.layers.Dense(units = 7, kernel_initializer = 'uniform', activation = 'relu', input_dim = 21))

# Adding the second hidden layer
classifier.add(keras.layers.Dense(units = 21, kernel_initializer = 'uniform', activation = 'relu'))

# Adding the output layer
classifier.add(keras.layers.Dense(units = 7, kernel_initializer = 'uniform', activation = 'softmax'))
